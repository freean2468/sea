...
DROP TABLE IF EXISTS sea_pay_heart;

CREATE TABLE sea_log.sea_pay_heart(
	id INT NOT NULL AUTO_INCREMENT,
	k_id VARCHAR(40) NOT NULL,
	w_date DATE NOT NULL,
	w_time TIME NOT NULL,
	paid_heart SMALLINT NOT NULL,
...
DROP PROCEDURE IF EXISTS sea_AddLogPayHeart $$
CREATE PROCEDURE sea_AddLogPayHeart(IN p_k_id VARCHAR (40) CHARACTER SET utf8, IN p_paid_heart SMALLINT, IN p_rest_coin MEDIUMINT)
	BEGIN
