...
DROP TABLE IF EXISTS sea_user_unregister;

CREATE TABLE sea_log.sea_user_unregister(
...
DROP PROCEDURE IF EXISTS sea_AddLogUnregister $$
CREATE PROCEDURE sea_AddLogUnregister(IN p_k_id VARCHAR (40) CHARACTER SET utf8)
	BEGIN
		INSERT sea_user_unregister(k_id, w_date, w_time)
