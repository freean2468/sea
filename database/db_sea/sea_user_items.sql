...
CREATE PROCEDURE sea_LoadItems(IN p_id INT UNSIGNED)
	BEGIN
...
CREATE PROCEDURE sea_UpdateExpBoost(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateItemLast(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateMaxAttack(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateShield(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateGhost(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateWeaponEnforce(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateBonusHeart(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateDropUp(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateMagnet(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
...
CREATE PROCEDURE sea_UpdateBonusScore(IN p_id INT UNSIGNED, IN p_count TINYINT)
	BEGIN
