var log = require('./log'),
	CCU = require('./session').CCU,
	MINUTE = require('../common/define').MINUTE,
	weekday = require('../common/define').weekday,
	build = require('./c2g-proto-build'),
	request = require('./a2l-request').request,
	mysql = require('./mysql'),
	lastDay = weekday[new Date().getDay()];
